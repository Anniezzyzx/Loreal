    ...
    init: function init() {
      ...
      function frame0() {
        ...
        tl.add("start").from('#product_1', 1, {
          ...
          autoAlpha: 0,
          ease: Cubic.easeInOut
        }, "start").staggerFrom(['#txt_2, #txt_3, #txt_4'], 1.5, {
          autoAlpha: 0,
          ease: Cubic.easeInOut
        }, 0.5, "start").add("leave") //.to('#product_1',1,{x:-175},"leave")
        //.to('#product_2',1,{x:175},"leave")
        .to(['#txt_1'], 1, {
          autoAlpha: 0
        }, "+=1") //.from('#she',1,{height:0, y:450},"-=0.5")
        .staggerTo(['#txt_2, #txt_3,#txt_4'], 1, {
          autoAlpha: 0
        }, 0.5, "-=0.5").set('#she', {
          autoAlpha: 1
        }, "-=0.5").to('#rectangle', 1, {
          ...
          autoAlpha: 0
        }, "-=0.5").staggerTo('#txt_5', 1, {
          autoAlpha: 0
        }, 0.5, "+=1").set('#she', {
          autoAlpha: 0
        }) //.to('#she',1,{height:0, y:450},"-=0.5")
        .add("enter").to('#rectangle', 1, {
          x: "-=101",
          ease: Cubic.easeOut
        }, "enter") //.to('#product_1',1,{x:0,scale:1},"enter")
        //.to('#product_2',1,{x:0,scale:1},"enter")
        .staggerFrom(['#txt_6, #txt_7, #txt_8'], 1, {
          autoAlpha: 0
        }, 0.5, "enter").from('#cta', 0.75, {
          autoAlpha: 0
        }).to('#corner_block', 4, {
          scaleY: 1.5,
          scaleX: 3,
