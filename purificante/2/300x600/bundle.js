    ...
    init: function init() {
      ...
      function frame0() {
        ...
        tl.from('#txt_1', 1, {
          ...
          repeat: 1,
          yoyo: true
        }).from('#background_1,#product_1,#txt_9', 0.3, {
          autoAlpha: 0
        }, '+=1') // .to('#logo_1',0.1,{autoAlpha:0},'-=0.4')
        .to('#glass,#txt_1,#shape', 0.1, {
          autoAlpha: 0
        }, '-=0.5') // .from('#logo_2',0.1,{autoAlpha:0},'-=0.3')
        .staggerFrom(['#txt_2', '#txt_3'], .5, {
          left: 300,
          ease: Cubic.easeOut
        }, .10, '+=0.2').staggerTo(['#txt_2', '#txt_3,#txt_9'], .5, {
          left: -600,
          ease: Cubic.easeIn,
          delay: 2.5
        }, .10).staggerFrom(['#txt_4', '#txt_5'], .5, {
          left: 300,
          ease: Cubic.easeOut
        }, .10, '+=0.2').staggerTo(['#txt_4', '#txt_5'], .5, {
          left: -600,
          ease: Cubic.easeIn,
          delay: 2.5
        }, .10).from('#background_2,#product_2', 0.1, {
          autoAlpha: 0
        }).staggerFrom(['#txt_6', '#txt_8'], .5, {
          left: 300,
          ease: Cubic.easeOut
        }, .10, '+=0.2').from('#cta', 0.5, {
          autoAlpha: 0
