    ...
    init: function init() {
      ...
      function frame0() {
        ...
        tl.from('#txt_1', 1, {
          ...
          repeat: 1,
          yoyo: true
        }).from('#background_1,#background_2,#product_1,#txt_7', 0.3, {
          autoAlpha: 0
        }, '+=1').to('#glass,#txt_1,#shape', 0.1, {
          autoAlpha: 0
        }, '-=0.5').staggerFrom(['#txt_2b', '#txt_2'], .5, {
          top: -40,
          ease: Cubic.easeOut
          ...
          ease: Cubic.easeIn,
          delay: 2.5
        }, .10).staggerFrom(['#txt_7', '#txt_3'], .5, {
          top: -40,
          ease: Cubic.easeOut
        }, .10, '+=0.2').staggerTo(['#txt_7,#txt_3'], .5, {
          top: 100,
          ease: Cubic.easeIn,
          delay: 2.5
