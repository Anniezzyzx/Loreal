  ...
  var Banner = {
    init: function init() {
      ...
      function frame0() {
        ...
        tl.staggerFrom(['#txt_3', '#txt_2', '#txt_1'], .5, {
          top: -40,
          ease: Cubic.easeOut
        }, .10, '+=0.2').staggerTo(['#txt_3', '#txt_2', '#txt_1'], .5, {
          top: 100,
          ease: Cubic.easeIn,
          delay: 2.5
        }, .10).from('#shape', 0.2, {
          ...
          scale: 0,
          ease: Cubic.easeOut
        }).staggerFrom(['#txt_6', '#txt_5', '#txt_4'], .5, {
          top: -40,
          ease: Cubic.easeOut
        }, .10, '+=0.2').staggerTo(['#txt_6', '#txt_5', '#txt_4'], .5, {
          top: 100,
          ease: Cubic.easeIn,
          delay: 2.5
        }, .10).staggerFrom(['#txt_8', '#txt_7'], .5, {
          top: -40,
          ease: Cubic.easeOut
        }, .10, '+=0.2').staggerTo(['#txt_8', '#txt_7'], .5, {
          top: 100,
          ease: Cubic.easeIn,
          delay: 2.5
        }, .10).to('#frame,#product_1', 0.2, {
          autoAlpha: 0
        }).from('#product_2', 0.2, {
          autoAlpha: 0
        }).staggerFrom(['#txt_11', '#txt_10', '#txt_9'], .5, {
          top: -40,
          ease: Cubic.easeOut
        }, .10, '+=0.2').staggerTo(['#txt_11', '#txt_10', '#txt_9'], .5, {
          top: 100,
          ease: Cubic.easeIn,
          delay: 2.5
        }, .10).to('#product_2,#shape', 0.2, {
          autoAlpha: 0
        }).to('#product_1', 0.2, {
          autoAlpha: 1
        }).from('#txt_12', 0.2, {
          autoAlpha: 0
        }); // .from('#cta',0.2,{autoAlpha:0},'+=0.7')
      } ////////////////////////////////////////////////////// EVENT HANDLERS //////////////////////////////////////////////////////
