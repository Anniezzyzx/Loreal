    ...
    init: function init() {
      ...
      function frame0() {
        ...
        master.add(slideProduct('#overlay-01', '#ffa300', '#icecream', '#product-02', '#txt_2'), '+=2.7').set(['#product-01', '#txt_1a', '#txt_1b'], {
          autoAlpha: 0
        }, '-=0.5').add(slideProduct('#overlay-02', '#e86025', '#duck', '#product-03', '#txt_3', ['#overlay-01', '#icecream', '#product-02', '#txt_2']), '+=1.7').add(slideProduct('#overlay-03', '#facbd5', '#waves', '#product-04', '#txt_4', ['#overlay-02', '#duck', '#product-03', '#txt_3']), '+=1.7').add(slideProduct('#overlay-04', '#ffc200', '#sunglasses', '#product-05', '#txt_5', ['#overlay-03', '#waves', '#product-04', '#txt_4']), '+=1.7').to(['#product-05', '#txt_5'], 1, {
          autoAlpha: 0
        }, '+=1').to('#overlay-04', 1, {
          y: -adHeight - adHeight / 2,
          ease: Cubic.easeInOut
