(function () {
  ...
  var Banner = {
    init: function init() {
      ...
      function frame0() {
        function slideProduct(overlay, illustration, product, text, kill) {
          var tl = new TimelineLite();
          tl.from(overlay, 0.5, {
            y: -adHeight,
            ease: Cubic.easeInOut
          }).add('invisible', '-=0.45').from([illustration, product, text], 1, {
            autoAlpha: 0
          });
        ...
        master.add(slideProduct('#overlay-01', '#icecream', '#product-02', '#txt_2'), '+=2.2').add(slideProduct('#overlay-02', '#duck', '#product-03', '#txt_3', ['#overlay-01', '#icecream', '#product-02', '#txt_2']), '+=1.2').add(slideProduct('#overlay-03', '#waves', '#product-04', '#txt_4', ['#overlay-02', '#duck', '#product-03', '#txt_3']), '+=1.2').add(slideProduct('#overlay-04', '#sunglasses', '#product-05', '#txt_5', ['#overlay-03', '#waves', '#product-04', '#txt_4']), '+=1.2').to(['#sunglasses', '#product-05', '#txt_5'], 1, {
          autoAlpha: 0
        }, '+=1.2').to('#overlay-04', 0.5, {
          y: -adHeight,
          ease: Cubic.easeInOut
        }, '-=1').from('#cta', 1, {
          autoAlpha: 0
