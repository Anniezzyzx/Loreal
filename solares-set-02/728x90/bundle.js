  ...
  var Banner = {
    init: function init() {
      ...
      function frame0() {
        ...
        master.add(slideProduct('#overlay-01', '#icecream', '#product-02', '#txt_2'), '+=2.2').add(slideProduct('#overlay-02', '#waves', '#product-03', '#txt_3', ['#overlay-01', '#icecream', '#product-02', '#txt_2']), '+=1.2').add(slideProduct('#overlay-03', '#sunglasses', '#product-04', '#txt_4', ['#overlay-02', '#waves', '#product-03', '#txt_3']), '+=1.2').to(['#sunglasses', '#product-04', '#txt_4'], 1, {
          autoAlpha: 0
        }, '+=1.2').to('#overlay-03', 0.5, {
          y: -adHeight,
          ease: Cubic.easeInOut
        }, '-=0.5').from('#cta', 1, {
          autoAlpha: 0
