    ...
    init: function init() {
      ...
      function frame0() {
        ...
        master.add(slideProduct('#overlay-01', '#product-02', '#txt_2'), '+=2.5').set(['#txt_1a', '#txt_1b'], {
          autoAlpha: 0
        }).add(slideProduct('#overlay-02', '#product-03', '#txt_3', ['#overlay-01', '#product-02', '#txt_2']), '+=1.125').add(slideProduct('#overlay-03', '#product-04', '#txt_4', ['#overlay-02', '#product-03', '#txt_3']), '+=1.125').to(['#product-04', '#txt_4'], 1, {
          autoAlpha: 0
        }, '+=1.125').to('#overlay-03', 0.5, {
          y: -adHeight,
          ease: Cubic.easeInOut
        }, '-=0.5').set('#product-01', {
          autoAlpha: 1
