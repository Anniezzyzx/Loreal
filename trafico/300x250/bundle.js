  ...
  var Banner = {
    init: function init() {
      ...
      function frame0() {
        ...
        tl.to('#product_1,#txt_1', 0.1, {
          autoAlpha: 0,
          ease: Cubic.easeOut
        }, '+=2').staggerFrom(['#she,#puntos_frente,#puntos_mejilla,#puntos_barbilla,#txt_5,#txt_2'], 0.3, {
          autoAlpha: 0,
          ease: Cubic.easeOut
        }, 0.5).staggerFrom(['#square'], 0.5, {
          scale: 0
        }, 0.5).from('#txt_3', 0.1, {
          autoAlpha: 0,
          ease: Cubic.easeOut
          ...
          autoAlpha: 0,
          ease: Cubic.easeOut
        }).to('#txt_2,#txt_4,#square,#txt_5,#she', 0.1, {
          autoAlpha: 0,
          ease: Cubic.easeOut
        }, '+=3').to('#product_1,#txt_1', 0.1, {
          autoAlpha: 1,
          ease: Cubic.easeOut
